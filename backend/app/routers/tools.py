...
TOOLS = [
    # ══════════════════════════════════════════════════════
    # 🟢 REAL - These actually execute tools or hit live APIs
    # ══════════════════════════════════════════════════════

    # ── LIVE SCANNERS (execute in Kali sandbox) ──────
    ...
    # ── LIVE THREAT INTEL (real API calls) ───────────
    ...
    # ── SIEM INTEGRATION (real connections) ───────────
    ...
    # ══════════════════════════════════════════════════════
    # 🔵 AI-POWERED - AI generates real, usable output
    # ══════════════════════════════════════════════════════

    # ── DETECTION & ANALYSIS (AI expert) ─────────────
    ...
    # ── THREAT HUNTING & RULE GENERATION ─────────────
    ...
    # ── FRAMEWORKS & COMPLIANCE (AI knowledge) ───────
...
TOOL_QUERIES = {
    # ═══ LIVE SCANNERS (real execution in sandbox) ═══
    "Nmap Scanner": [
    ...
    # ═══ SIEM INTEGRATION (real Elasticsearch) ═══
    "ELK Stack SIEM": [
    ...
    # ═══ AI-POWERED (generates real output) ═══
    "Threat Detection": [
